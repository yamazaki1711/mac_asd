...
Документ актуализирован. Workflow реализован через LangGraph StateGraph с оркестрацией Hermes. Детальные навыки агентов описаны в CONCEPT_Agent_Skills_and_Workflows.pdf.
