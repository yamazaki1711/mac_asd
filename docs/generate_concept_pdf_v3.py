#!/usr/bin/env python3
"""
MAC ASD v12.0.0 — Навыки агентов и рабочие процессы (v3).
...
def build_content():
    ...
    story.append(p(
        'Агент Юрист - единственный полностью функциональный агент в текущей реализации (v12.0.0). '
    ...
    story.extend(add_h2('5.3. БЛС: База ловушек подрядчика (v12.0.0)'))
    story.append(p(
        ...
        'ловушки добавлены в v12.0.0: согласование субподрядчиков с Заказчиком (ст. 706 ГК РФ), '
    ...
    story.append(Paragraph('Таблица 11. Стек технологий MAC ASD v12.0.0', CAPTION_STYLE))
    story.append(Spacer(1, 12))
    ...
    story.append(p(
        ...
        'и приоритеты бизнес-логики. Юрист уже реализован (v12.0.0), следующие приоритеты - '
    ...
    roadmap = [
        ...
        [Paragraph('P1', TABLE_CELL_CENTER),
         ...
         Paragraph('Юрист', TABLE_CELL_STYLE),
         Paragraph('Готово (v12.0.0)', TABLE_CELL_STYLE)],
