...
Документ актуализирован для АСД v11.3 (20 апреля 2026). Спецификации инструментов используются при реализации MCP-тулов в Packages 2-10. Все агенты используют Gemma 4 31B через разделяемую память LLMEngine; Руководитель проекта использует Llama 3.3 70B. Визионный анализ выполняется minicpm-v по требованию.
