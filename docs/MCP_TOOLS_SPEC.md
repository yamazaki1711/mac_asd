...
*   Общее количество инструментов: **8** (реализовано в mcp_servers/asd_core/server.py; 16 модулей-заглушек).
...
АСД v13.0 содержит **61 ловушка** в 11 категориях:
