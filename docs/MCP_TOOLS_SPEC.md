...
18 MCP инструментов, 4 модуля + 1 общий.
Каждый инструмент — точный контракт: аргументы, возвращаемое значение, ошибки.
...
Этот документ определяет точные контракты всех 18 MCP инструментов.
