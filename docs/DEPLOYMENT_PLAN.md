...
**Цель:** Пошаговая инструкция на день когда Mac Studio будет доставлен
...
От распаковки до рабочего MCP сервера с 18 инструментами.
...
- [ ] Все 18 MCP инструментов работают
- [ ] E2E тесты пройдены
...
Этот документ — пошаговый план развёртывания АСД на Mac Studio.
Использовать в день когда Mac Studio будет доставлен.
