...
Документ актуализирован для АСД v11.3 (20 апреля 2026). При развертывании использовать переменную ASD_PROFILE=mac_studio и конфигурацию из .env. Основная модель — Gemma 4 31B 4-bit (все агенты), PM — Llama 3.3 70B 4-bit (Руководитель проекта).
