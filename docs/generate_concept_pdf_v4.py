...
def build_content():
    ...
    story.append(p(
        'БЛС (База Ловушек Подрядчика) в версии v12.0.0 содержит 58 ловушек, распределённых '
    ...
    story.append(Paragraph('Таблица 13. Категории БЛС v12.0.0 (58 ловушек, 10 категорий)', CAPTION_STYLE))
    story.append(Spacer(1, 12))
