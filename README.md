...
Мультиагентная система на базе LLM для строительного субподряда. Два режима: forensic-восстановление исполнительной документации на проблемных ОКС и сопровождение стройки (тендеры, снабжение, генерация ИД, претензии).
