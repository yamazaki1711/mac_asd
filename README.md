...
|| **Quality Cascade** | `src/core/quality_metrics.py` | **Новый**. Каскад качества (АФИДА): измерение потерь на 5 этапах конвейера, waterfall |
...
│   ├── quality_metrics.py                       # Каскад качества (НОВОЕ)
