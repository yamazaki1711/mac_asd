"""
ASD v11.3.0 — Seed Lab Organizations.
...
SEED_LABS = [
    {
        ...
        "scope": [
            ...
            {"method": "УЗК", "gost": "ГОСТ 14782-86", "description": "Ультразвуковой контроль сварных соединений"},
    ...
    },
    {
        ...
        "scope": [
            ...
            {"method": "Средняя плотность", "gost": "ГОСТ 12730.1-78", "description": "Определение средней плотности бетона"},
        ],
        "contact_info": {
    ...
    },
    {
        ...
        "scope": [
            ...
            {"method": "УЗК", "gost": "ГОСТ 14782-86", "description": "Ультразвуковой контроль"},
            {"method": "МПК", "gost": "ГОСТ 21105-87", "description": "Магнито-порошковый контроль"},
