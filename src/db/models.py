...
class LegalTrap(Base):
    ...
    v11.2.2: Добавлены поля channel, category, weight для интеграции с каталогом каналов.
    """
    ...
    channel = Column(String(255))  # v11.2.2: Username канала (e.g., "advokatgrikevich")
    category = Column(String(100))  # v11.2.2: legal_practice | legal_association | legal_education | legal_news
    weight = Column(Integer, default=100)  # v11.2.2: Вес 0-100 для RAG scoring (из каталога: weight*100)
