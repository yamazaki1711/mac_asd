...
class DocumentType(str, Enum):
    ...
    M4 = "m4"                           # Приходный ордер М-4
    M11 = "m11"                         # Требование-накладная М-11
    M15 = "m15"                         # Накладная на отпуск материалов на сторону М-15
    M29 = "m29"                         # Акт списания материалов М-29
...
DOCUMENT_KEYWORDS: Dict[DocumentType, List[Dict[str, Any]]] = {
    ...
    DocumentType.TORG12: [
        {"keywords": ["товарная накладная", "торг-12", "торг12",
                      "форма № торг-12", "отпуск груза", "отпуск товара"],
         "weight": 10, "must_have": ["торг-12"]},
    ],
    DocumentType.M4: [
        {"keywords": ["приходный ордер", "м-4", "форма № м-4",
                      "оприходование", "принято на склад", "приходный"],
         "weight": 8, "must_have": ["м-4"]},
    ],
    DocumentType.M11: [
        {"keywords": ["требование-накладная", "м-11", "форма № м-11",
                      "отпуск материалов", "выдача в производство"],
         "weight": 8, "must_have": ["м-11"]},
    ],
    DocumentType.M15: [
        {"keywords": ["накладная на отпуск материалов на сторону", "м-15",
                      "форма № м-15", "отпуск на сторону", "передача субподрядчику"],
         "weight": 8, "must_have": ["м-15"]},
    ],
    DocumentType.M29: [
        {"keywords": ["акт списания материалов", "м-29", "форма № м-29",
                      "списание материалов", "списание тмц", "отчёт о расходе"],
         "weight": 8, "must_have": ["м-29"]},
    ],
    DocumentType.UPD: [
