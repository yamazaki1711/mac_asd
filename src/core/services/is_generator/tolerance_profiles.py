...
Связанные нормы:
    СП 70.13330.2025 — Несущие и ограждающие конструкции
...
SP126_PROFILES: list[ToleranceProfile] = [
    ...
    ToleranceProfile(
        ...
        tolerance_mm=15.0,
        sp_reference="СП 70.13330.2025, табл. 4.3",
    ...
    ToleranceProfile(
        ...
        label="Ростверки",
        tolerance_mm=10.0,
        sp_reference="СП 70.13330.2025, табл. 4.4",
    ...
    ToleranceProfile(
        ...
        tolerance_mm=5.0,
        sp_reference="СП 70.13330.2025, табл. 4.9",
        class_precision="I",
    ),
    ToleranceProfile(
        key="КМ_ОТМЕТКИ",
        ...
        tolerance_mm=5.0,
        sp_reference="СП 70.13330.2025, табл. 4.10",
        class_precision="I",
    ),
    ToleranceProfile(
        ...
        tolerance_mm=10.0,
        sp_reference="СП 70.13330.2025, табл. 4.11",
        class_precision="II",
    ...
    ToleranceProfile(
        ...
        tolerance_mm=8.0,
        sp_reference="СП 70.13330.2025, табл. 4.5",
        class_precision="II",
    ),
    ToleranceProfile(
        key="КЖ_ПЕРЕКРЫТИЯ",
        ...
        tolerance_mm=5.0,
        sp_reference="СП 70.13330.2025, табл. 4.6",
        class_precision="I",
    ),
    ToleranceProfile(
        key="КЖ_СТЕНЫ",
        ...
        tolerance_mm=10.0,
        sp_reference="СП 70.13330.2025, табл. 4.7",
        class_precision="II",
