...
_NORM_TO_PACKAGE: Dict[str, str] = {
    ...
    "сп 70.13330": "10_СП_70.13330.2025",
...
_WORK_TYPE_TO_PACKAGES: Dict[str, List[str]] = {
    ...
    "06_concrete": ["10_СП_70.13330.2025", "01_Приказ_Минстроя_344_пр", "03_Приказ_Минстроя_1026_пр",
                     "27_СП_543.1325800.2024"],
    "07_steel": ["09_СП_68.13330.2017", "30_ГОСТ_23118-2019", "01_Приказ_Минстроя_344_пр",
                  "10_СП_70.13330.2025"],
    "08_precast-concrete": ["10_СП_70.13330.2025", "01_Приказ_Минстроя_344_пр",
                             "27_СП_543.1325800.2024"],
