"""
ASD v11.0 — Legal ID Composition Skill.
...
class LegalIDComposition(SkillBase):
    ...
    ID_REQUIREMENTS: Dict[str, Dict[str, Any]] = {
        ...
        "бетонные": {
            "primary_acts": [
                {
                    "type": "АОСР",
                    "description": "Акты освидетельствования скрытых работ",
                    "regulation": "Приказ № 344/пр, СП 70.13330.2012",
                    "stages": [
            ...
            "additional": [
                "Акты испытания бетонных кубиков (ГОСТ 18105-2010)",
