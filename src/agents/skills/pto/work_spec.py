...
WORK_JOURNALS: Dict[str, List[Dict[str, Any]]] = {
    ...
    WorkType.FOUNDATION_MONOLITHIC: [
        ...
        },
        {
            ...
            "form": "СП 70.13330.2025 / температурный лист",
            "mandatory": False,
    ...
    WorkType.FOUNDATION_PILE: [
        COMMON_JOURNAL_OJR,
        {
            ...
            "form": "СП 45.13330.2017 / СП 70.13330.2025",
            "mandatory": True,
        ...
        },
        {
            ...
            "form": "СП 70.13330.2025, Приложение И",
            "mandatory": False,
...
WORK_CERTIFICATES: Dict[str, List[Dict[str, Any]]] = {
    ...
    WorkType.MASONRY: [
        {"name": "Протокол проверки фактической прочности раствора в кладке", "mandatory": False, "conditional": "только при зимней кладке (п. 9.16.2 СП 70.13330.2025)", "note": "При перегрузках нижележащих конструкций в период оттаивания"},
        {"name": "Документы оценки соответствия, паспорта", "mandatory": True},
    ],
    WorkType.FINISHING_FLOORS: [
...
WORK_REGULATIONS: Dict[str, List[Dict[str, str]]] = {
    ...
    WorkType.FOUNDATION_MONOLITHIC: [
        *COMMON_REGULATIONS,
        {"code": "СП 45.13330.2017", "note": "Земляные сооружения, основания и фундаменты", "status": "действует"},
        {"code": "СП 70.13330.2025", "note": "Несущие и ограждающие конструкции (изм. 1-7)", "status": "действует"},
        {"code": "СП 435.1325800.2018", "note": "Конструкции бетонные и ЖБ монолитные", "status": "действует"},
    ],
    WorkType.FOUNDATION_PRECAST: [
        *COMMON_REGULATIONS,
        {"code": "СП 45.13330.2017", "note": "Земляные сооружения, основания и фундаменты", "status": "действует"},
        {"code": "СП 70.13330.2025", "note": "Несущие и ограждающие конструкции", "status": "действует"},
    ],
    WorkType.FOUNDATION_PILE: [
        *COMMON_REGULATIONS,
        {"code": "СП 45.13330.2017", "note": "Земляные сооружения, основания и фундаменты", "status": "действует"},
    ...
    WorkType.METAL_STRUCTURES: [
        {
            ...
            "source": "Пособие 5.6; СП 70.13330.2025",
        },
        {
    ...
    WorkType.MASONRY: [
        {
            ...
            "source": "СП 70.13330.2025 п. 9.1.8",
        },
        {
